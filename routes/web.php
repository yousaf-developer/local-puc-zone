...
use App\Http\Controllers\AdminV2\AdminV2Controller;
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['AdminAuth']], function () {
        ...
        // version 2 routes
        Route::get('/dashboard', [AdminV2Controller::class, 'dashboard'])->name('admin.dashboard');
...
// yousaf ajax new route start

Route::post('/getAnalyticsPageData', [AdminV2Controller::class, 'getAnalyticsPageData'])->name('admin.getAnalyticsPageData');


// yousaf ajax new routes ens
        ...
        Route::post('showPucUploadPhotosAdmin', [AdminController::class, 'showPucUploadPhotosAdmin'])->name('admin.showPucUploadPhotosAdmin');;
...
Route::group(['prefix' => '/'], function () {
    ...
    Route::group(['middleware' => ['UserAuth']], function () {
        ...
        Route::post('showPucUploadPhotos', [FrontEndController::class, 'showPucUploadPhotos'])->name('showPucUploadPhotos');
...
//--------------------------------------Razor Pay Routes start ----------------------------------------------
Route::post('user/addwallet/online/pay', [PaymentController::class, 'addWalletOnline'])->name('user.addwallet.online.pay');
Route::post('payment/callbackwallet', [PaymentController::class, 'callbackWallet'])->name('payment.callbackwallet');
Route::post('/register/payment', [PaymentController::class, 'registerPayment'])->name('register.payment');
Route::post('payment/callback', [PaymentController::class, 'callbackRegister'])->name('payment.callbackregister');

//-------------------------------------Razor Pay Routes end --------------------------------------------------
