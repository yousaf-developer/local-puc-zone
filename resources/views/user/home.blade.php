    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <section>
            ...
            <div class="container-fluid vehicle-details-container g-0" id="makePuc_section">
                ...
                <form class="row g-3 register pt-4" id="puc_create_form" novalidate enctype="multipart/form-data">
                    
                    @foreach($userPucTypes as $rate)
                        <div class="col-4 col-md-4">
                            <div class="type-div puc_type_opt" data-id="{{$rate->puc_type_id}}">
                                {!! $rate->pucType->svg_image !!}
                                <p class="pt-1">{{$rate->pucType->name}}</p>
                            </div>
                        </div>
                    @endforeach
                    <!-- <div class="col-4 col-md-4">
                        <div class="type-div active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24"><path fill="currentColor" d="M4 13.256V12H2v-2h6.365L11.2 8h3.492L13.6 5H11V3h4l1.092 3H20v3h-2.816l1.456 4.002a4.5 4.5 0 1 1-1.985.392L15.419 10h-.947l-1.582 5.87l-.002-.001l.002.005l-2.925 1.065q.035.276.035.561a4.5 4.5 0 1 1-6-4.244m2-.229a4.5 4.5 0 0 1 3.281 2.033l1.957-.713L12.403 10h-.547L9 12H6zM5.5 20a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5m13 0a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5"/></svg>
                            <p class="pt-1">2 Wheller</p>
                        </div>
                    </div>
                    <div class="col-4 col-md-4">
                        <div class="type-div">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor"><path d="M9.007 17a2 2 0 1 1-4 0a2 2 0 0 1 4 0m10 0a2 2 0 1 1-4 0a2 2 0 0 1 4 0"/><path d="M2.007 10h16m-16 0c0 .78-.02 3.04.004 5.26c.036.72.156 1.32 2.998 1.74m-3.002-7c.216-1.74 1.155-3.8 1.635-4.58M9.007 10V5m5.99 12H9.002M2.022 5H12.24s.54 0 1.02.048c.899.084 1.654.492 2.41 1.512c.8 1.08 1.414 2.448 2.23 3.18c1.355 1.216 3.933.84 4.077 3.42c.036 1.32.036 2.76-.024 3c-.097.707-.642.822-1.32.84c-.588.016-1.297-.028-1.642 0"/></g></svg>
                            <p class="pt-1">3 Wheller+</p>
                        </div>
                    </div>
                    <div class="col-4 col-md-4">
                        <div class="type-div">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.019-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z"/><path fill="currentColor" d="M18.93 5a3 3 0 0 1 2.38 1.173l.116.163l1.07 1.605a3 3 0 0 1 .496 1.443l.008.222V16a2 2 0 0 1-1.85 1.995L21 18h-.17a3.001 3.001 0 0 1-5.592.172L15.17 18H8.829a3.001 3.001 0 0 1-5.591.172L3.17 18H3a2 2 0 0 1-1.995-1.85L1 16V8a3 3 0 0 1 2.824-2.995L4 5zM18 16a1 1 0 1 0 0 2a1 1 0 0 0 0-2M6 16a1 1 0 1 0 0 2a1 1 0 0 0 0-2m12.93-9H18v4h3V9.606a1 1 0 0 0-.168-.555l-1.07-1.606A1 1 0 0 0 18.93 7M6 7H4a1 1 0 0 0-.993.883L3 8v2h3zm5 0H8v3h3zm5 0h-3v3h3z"/></g></svg>
                            <p class="pt-1">4 Wheller+</p>
                        </div>
                    </div> -->
                    <input type="hidden" id="puc_type" name="puc_type" value="" onchange="getPucTypeRate()">
                    ...
                    <div class="form-floating col-12 challan_opt_div" style="display:none;">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="row">
                            <div class="col-6">
                                <div class="col-md-12 col-12 d-flex challan px-2 mb-3 {{@$user->fine_rate == null ? 'd-none' : ''}}">
                                    <div class="form-floating" style="width:50%;">
                                        <label class="mx-2 px-0">PUC Fine</label>
                                    </div>
                                    <div class="form-floating custom-option" style="width:50%;">
                                        <select id="puc_fine" class="form-select " name="puc_fine" onchange="getPucTypeRate()">
                                            <option value="0">No</option>
                                            <option value="1">Yes</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-floating col-ms-12 col-12">
                                    ...
                                    <input type="hidden" id="puc_fine_rate" name="puc_fine_rate" value="0">
                                </div>
                            ...
                            <div class="col-6">
                                <div class="upload-container">
                                    <div class="upload-inner px-2 pt-2 cameraIcon pointer">
                                        <span>Upload vehicle photo</span>
                                        <input type="file" id="upload_vehicle" name="" accept="image/*" {{@$user->upload_option == '0' ? "capture=camera" : ''}}  multiple style="display: none;">
                                        <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11.0001 13.1714V1.28571M11.0001 1.28571L13.9144 4.48571M11.0001 1.28571L8.08582 4.48571" stroke="#515C6F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M7.11434 19.5714H14.8858C17.633 19.5714 19.0075 19.5714 19.8605 18.7687C20.7143 17.9641 20.7143 16.6722 20.7143 14.0857V13.1714C20.7143 10.5858 20.7143 9.29305 19.8605 8.48939C19.1144 7.78722 17.9701 7.69853 15.8572 7.68756M6.14291 7.68756C4.03005 7.69853 2.88571 7.78722 2.13965 8.48939C1.28577 9.29305 1.28577 10.5858 1.28577 13.1714V14.0857C1.28577 16.6722 1.28577 17.965 2.13965 18.7687C2.43108 19.043 2.78274 19.2231 3.22862 19.342" stroke="#515C6F" stroke-width="1.5" stroke-linecap="round"></path>
                                        </svg>
                                    </div>
                                    <div class="upload-middle px-2">
                                        <div class="add-img-section cameraIcon pointer mb-2" id="upload_button">
                                            <span>Upload clear image</span>

                                            <div class="upload-btn mt-2 " style="">
                                                <p class="m-0">Click To Upload</p>
                                            </div>
                                        </div>
                                        
                                        <div class="upload-section" id="uploaded_section" style="display:none;">
                                            <span id="progress_text">Uploading...2/3</span>
                                            <div class="progress-container mb-1"> 
                                                <div class="custom-progress" id="progress_percent" style="width:0%;"></div> 
                                            </div> 

                                            <div class="row img-preview px-2" id="image_preview">
                                                <div class="col-4 px-1">
                                                    <img src="{{asset('assets_user/images/image-prev.png')}}">
                                                </div>
                                                <div class="col-4 px-1">
                                                    <img src="{{asset('assets_user/images/image-prev.png')}}">
                                                </div>
