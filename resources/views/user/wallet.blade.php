...
<script>
var minWalletAmount = {{getMinWalletAmount()}};
</script>
<section>
        <div class="container-fluid wallet-tab-container">
            ...
            <ul id="nav-wallet-tab" class="nav nav-pills pt-3 d-flex flex-nowrap align-items-center justify-content-between"
                ...
                <li class="nav-item" role="presentation">
                   ...
                   <input type="number" class="form-control transaction_amount" name="transaction_amount" maxlength="6" id="transaction_amount" style="width:160px; height:52px; font-size:15px; font-weight:800;" placeholder="₹ {{getMinWalletAmount()}}" required >
...
@endforeach
    ...
    <form id="online_pay_form" action="{{route('user.addwallet.online.pay')}}" method="POST" style="display:none;">
        @csrf
        <input type="number" id="online_amount" name="amount">
    </form>
