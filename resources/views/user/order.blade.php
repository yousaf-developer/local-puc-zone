            ...
            <form class="row g-3 register pt-4" id="puc_create_form" novalidate>
                ...
                @foreach($userPucTypes as $rate)
                    <div class="col-4 col-md-4">
                        <div class="type-div puc_type_opt" id="puc_type_opt_{{$rate->puc_type_id}}" data-id="{{$rate->puc_type_id}}">
                ...
                <!-- <div class="form-floating col-6 col-md-4">
                    <div id="cameraIcon" class="upload px-4 d-flex align-items-center justify-content-between">
                        ...
                        <input type="file" accept="image/*" {{@$user->upload_option == '0' ? "capture=camera" : ''}}  id="upload_vehicle" name="" multiple style="display: none;">
...
<div class="modal fade bottom-to-top" id="uploadsModal" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog h-100 d-flex align-items-center justify-content-center">
        <div class="modal-content">
            ...
            <div class="modal-body gap-3 align-items-center justify-content-center">
                <div class="border rounded-4 w-100 p-2" id="puc_vehicle_img_div">
                    <span class="text-start fw-semibold">Vehicle Photo</span>
                    <div class="vehicle-photo  align-items-center justify-content-center">
