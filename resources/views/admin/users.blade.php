            ...
            <form class="row g-3 register my-0" id="registration_form" novalidate="">
                ...
                <div class="form-floating col-6 col-md-4 my-2">
                    <div id="cameraIcon" class="upload px-4 d-flex align-items-center justify-content-between py-3">
                        ...
                        <input type="file" accept="image/*" capture="camera" id="upload_picture" name="" multiple="false" style="display: none;"><!--upload_picture-->
                ...
                <div class="form-floating col-6 col-md-4 my-2">
                    <div id="aadharUploadIcon" class="upload px-4 d-flex align-items-center justify-content-between py-3">
                        ...
                        <input type="file" id="upload_aadhar" name="" multiple="false" style="display: none;" accept="image/*"><!-- upload_aadhar -->
                ...
                <div class="form-floating col-3 col-md-3 my-2">
                    <input type="number" class="form-control users-details-inputs form-control-sm rmv-arrow" id="puc_fine_rate" name="puc_fine_rate"
                        placeholder="Fine Rate" maxlength="3">
                    <label class="ms-2 d-flex align-items-center" for="puc_fine_rate">Puc Fine</label>
                </div>
