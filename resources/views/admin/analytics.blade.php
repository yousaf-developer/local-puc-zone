...
<section>
    ...
    <div class="analytics-container">
        ...
        <div class="analytics-card-content px-sm-4 px-3 py-2 d-flex flex-column align-items-center ">
            <span class="analytics-card-content-heading" id="c_fine_qty">0</span>
            <p class="text-center m-0 analytics-card-content-paragraph pt-2">Fine Quantity</p>
        </div>

        <div class="analytics-card-content px-sm-4 px-3 py-2 d-flex flex-column align-items-center ">
            <span class="analytics-card-content-heading" id="c_fine_amount">₹0</span>
            <p class="text-center m-0 analytics-card-content-paragraph pt-2">Fine Amount</p>
        </div>
